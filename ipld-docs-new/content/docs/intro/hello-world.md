...
title: "Hello, World"
weight: 1
description: "An introduction to IPLD, and what range of concepts are inside it."
---
...
What's neat about content-addressing is that because it does *not* involve talking about data *location*,
...
you don't need to go look online *to some specific server* to get the rest of the linked documents;
you can get them anywhere that content can be found.

Content-addressing also separates document *identity* from discussion of *authority*.
