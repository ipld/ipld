...
weight: 38
description: "A decision tree for how to get things done with IPLD, and what parts of the system to try to apply first when problem solving."
---
...
in weight: if you can get something done with the things at the top of this file,
...
data *without them*, and just handle the raw Data Model contents directly.
