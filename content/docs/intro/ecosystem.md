...
weight: 3
description: "An overview of the various other Interplanetary and Protocol Labs projects, such as IPFS and libp2p, and how they typically fit together with IPLD in a bigger picture."
---
...
Multiaddrs are one of the multiformats that IPLD has the _least_ to do with.
