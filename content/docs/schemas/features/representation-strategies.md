...
- [Representation Strategy Reference](#representation-strategy-reference)
  - [Struct `map` Representation](#struct-map-representation)
    - [Representation Kind: Map](#representation-kind-map)
    - [Example](#example)
  - [Struct `tuple` Representation](#struct-tuple-representation)
    - [Representation Kind: List](#representation-kind-list)
    - [Example](#example-1)
    - [Example](#example-2)
  - [Struct `stringpairs` Representation](#struct-stringpairs-representation)
    - [Representation Kind: String](#representation-kind-string)
    - [Example](#example-3)
  - [Struct `stringjoin` Representation](#struct-stringjoin-representation)
    - [Representation Kind: String](#representation-kind-string-1)
    - [Example](#example-4)
  - [Struct `listpairs` Representation](#struct-listpairs-representation)
    - [Representation Kind: List](#representation-kind-list-1)
    - [Example](#example-5)
  - [Map `map` Representation](#map-map-representation)
    - [Representation Kind: Map](#representation-kind-map-1)
    - [Example](#example-6)
  - [Map `stringpairs` Representation](#map-stringpairs-representation)
    - [Representation Kind: String](#representation-kind-string-2)
    - [Example](#example-7)
  - [Map `listpairs` Representation](#map-listpairs-representation)
    - [Representation Kind: List](#representation-kind-list-2)
    - [Example](#example-8)
  - [Union `keyed` Representation](#union-keyed-representation)
    - [Representation Kind: Map (single entry of current node)](#representation-kind-map-single-entry-of-current-node)
    - [Example](#example-9)
  - [Union `kinded` Representation](#union-kinded-representation)
    - [Representation Kind: _Various_](#representation-kind-various)
    - [Example](#example-10)
  - [Union `envelope` Representation](#union-envelope-representation)
    - [Representation Kind: Map (two entries of current node)](#representation-kind-map-two-entries-of-current-node)
    - [Example](#example-11)
  - [Union `inline` Representation](#union-inline-representation)
    - [Representation Kind: Map (only some entries of current node)](#representation-kind-map-only-some-entries-of-current-node)
    - [Example](#example-12)
  - [Union `stringprefix` Representation](#union-stringprefix-representation)
    - [Representation Kind: String](#representation-kind-string-3)
  - [Union `bytesprefix` Representation](#union-bytesprefix-representation)
    - [Representation Kind: Bytes](#representation-kind-bytes)
    - [Example](#example-13)
  - [Enum `string` Representation](#enum-string-representation)
    - [Representation Kind: String](#representation-kind-string-4)
    - [Example](#example-14)
    - [Example](#example-15)
  - [Enum `int` Representation](#enum-int-representation)
    - [Representation Kind: Int](#representation-kind-int)
    - [Example](#example-16)
